...
INDUSTRY_KEYWORDS: Dict[str, str] = {
    ...
    "酒店": "Travel", "民宿": "Travel", "度假": "Travel",
    "hotel": "Travel", "trip": "Travel", "vacation": "Travel", "tourism": "Travel",
    "时尚": "Fashion", "fashion": "Fashion", "服装": "Fashion", "穿搭": "Fashion",
    "潮流": "Fashion", "服饰": "Fashion", "美妆": "Fashion",
    "style": "Fashion", "clothing": "Fashion", "beauty": "Fashion", "makeup": "Fashion",
    "房地产": "Real Estate", "地产": "Real Estate", "楼盘": "Real Estate",
    "房产": "Real Estate", "置业": "Real Estate", "公寓": "Real Estate",
    "property": "Real Estate", "real estate": "Real Estate", "apartment": "Real Estate",
}
...
VIBE_KEYWORDS: Dict[str, str] = {
    ...
    "老式": "Vintage", "古典": "Vintage",
    "retro": "Vintage", "classic": "Vintage", "nostalgic": "Vintage",
    "现代": "Modern", "modern": "Modern", "当代": "Modern", "前卫": "Modern",
    "未来": "Modern", "科幻": "Modern",
    "futuristic": "Modern", "contemporary": "Modern", "sleek": "Modern",
    "cyberpunk": "Modern", "sci-fi": "Modern",
    "自然": "Natural", "natural": "Natural", "环保": "Natural", "绿色": "Natural",
    "有机": "Natural", "生态": "Natural",
    "organic": "Natural", "eco": "Natural", "earthy": "Natural", "botanical": "Natural",
    "elegant": "Elegant", "优雅": "Elegant", "精致": "Elegant", "高雅": "Elegant",
    "graceful": "Elegant", "sophisticated": "Elegant", "luxury": "Elegant",
}

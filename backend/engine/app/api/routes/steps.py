...
_STYLE_HINTS = [
    "请选择 top_text 策略，标题左对齐在上方，背景视觉在下方",
    "请选择 centered 策略，极简居中，大留白",
    "请选择 bottom_heavy 策略，内容紧凑在底部，上方留给背景",
    "请选择 left_aligned 策略，杂志封面式紧凑排版",
    "请选择 diagonal 策略，标题左上 CTA 右下，视觉张力",
    "请选择 big_title 策略，超大标题占据视觉中心",
    "请选择 split_vertical 策略，上下分区，节奏清晰",
    "请自由选择最适合内容的 layout_strategy",
    "请结合布局策略推荐，选择最匹配的 layout_strategy",
]
